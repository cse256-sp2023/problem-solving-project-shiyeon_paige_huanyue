...
traverse_folder_execute_file_div = $("<div> - Traverse Folder allows or denies moving through folders to reach other files or folders, even if the user has no permissions for the traversed folders (applies to folders only). Execute File allows or denies running program files (applies to files only).</div><br><hr><br><b><div class='dia_explain'></div></b>")
list_folder_read_contents_div = $("<div> - List Folder allows or denies viewing file names and subfolder names within the folder (applies to folders only). Read Data allows or denies viewing data in files (applies to files only).</div><br><hr><br><b><div class='dia_explain'></div></b>")
read_attributes_div = $("<div> - Allows or denies viewing the attributes of a file or folder, such as read-only and hidden. Attributes are defined by NTFS file system.</div><br><hr><br><b><div class='dia_explain'></div><b>")
read_extended_attributes_div = $("<div> - Allows or denies viewing the extended attributes of a file or folder. Extended attributes are defined by programs and may vary by program.</div><br><hr><br><b><div class='dia_explain'></div></b>")
create_files_write_data_div = $("<div> - Create Files allows or denies creating files within the folder (applies to folders only). Write Data allows or denies making changes to the file and overwriting existing content (applies to files only).</div><br><hr><br><b><div class='dia_explain'></div></b>")
create_folders_append_data_div = $("<div> - Create Folders allows or denies creating folders within the folder (applies to folders only). Append Data allows or denies making changes to the end of the file but not changing, deleting, or overwriting existing data (applies to files only).</div><br><hr><br><b><div class='dia_explain'></div></b>")
write_attributes_div = $("<div> - Allows or denies changing the attributes of a file or folder, such as read-only or hidden. Attributes are defined by NTFS.</div><br><hr><br><b><div class='dia_explain'></div></b>")
write_extended_attributes_div = $("<div> - Allows or denies changing the extended attributes of a file or folder. Extended attributes are defined by programs and may vary by program.</div><br><hr><br><b><div class='dia_explain'></div></b>")
delete_subfolders_and_files_div = $("<div> - Allows or denies deleting subfolders and files, even if the Delete permission has not been granted on the subfolder or file.</div><br><hr><br><b><div class='dia_explain'></div></b>")
permission_delete_div = $("<div> - Allows or denies deleting the file or folder. If you do not have Delete permission on a file or folder, you can still delete it if you have been granted Delete Subfolders and Files on the parent folder.</div><br><hr><br><b><div class='dia_explain'></div></b>")
permission_read_div = $("<div> - Allows or denies reading permissions of the file or folder, such as Full Control, Read, and Write.</div><br><hr><br><b><div class='dia_explain'></div></b>")
change_permissions_div = $("<div> - Allows or denies changing permissions of the file or folder, such as Full Control, Read, and Write.</div><br><hr><br><b><div class='dia_explain'></div></b>")
take_ownership_div = $("<div> - Allows or denies taking ownership of the file or folder. The owner of a file or folder can always change permissions on it, regardless of any existing permissions that protect the file or folder.</div><br><hr><br><b><div class='dia_explain'></div></b>")
